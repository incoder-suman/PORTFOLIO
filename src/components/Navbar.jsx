    ...
    <div className="max-w-screen-2xl container mx-auto px-4 md:px-20 h-16 shadow-md fixed top-0 left-0 right-0 z-50 bg-slate-100">
        <div className="flex justify-between items-center h-16">
            <div className="flex space-x-2 items-center">
                <img src={myImage} className="h-12 w-12 rounded-full" alt="Logo" />
                <h1 className="font-semibold text-xl cursor-pointer">
                    Suma<span className="text-green-500 text-2xl">n</span>
        ...
        {menu && (
            ...
            {
                        navItems.map(({id,text}) =>(
                            <li className="hover:scale-105 duration-200 curser-pointer font-semibold"
                             key={id}
                             >
                                <Link
